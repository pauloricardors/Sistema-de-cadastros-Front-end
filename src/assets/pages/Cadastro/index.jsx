    ...
    return (
        <div className="max-w-md mx-auto mt-10 bg-white p-8 border border-gray-300 rounded-lg shadow-lg">
            ...
            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                <input ref={nameRef} placeholder="Nome" type="text" className="w-full py-2 pl-3 border border-gray-300 rounded-md focus:outline-none" />
            ...
            <Link to='/login' className="text-center text-blue-700 mt-4 block"> Já tem uma conta? Faça login</Link>
        </div>
    )
}
